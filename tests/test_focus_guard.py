...
from ghost_pulse.analyzers.focus_guard import FocusGuard
...
class TestFocusSessionDetection:
    def test_starts_session_on_first_activity(self):
        ...
        with patch("ghost_pulse.analyzers.focus_guard._send_notification"):
    ...
    def test_no_notification_below_threshold(self):
        ...
        with patch("ghost_pulse.analyzers.focus_guard._send_notification") as mock_notify:
